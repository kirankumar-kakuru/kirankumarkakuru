...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?logo=linkedin&style=flat)](www.linkedin.com/in/kiran-kumar-kakuru-853834193)
[![Gmail](https://img.shields.io/badge/Email-kiranwls6@gmail.com-red?logo=gmail&style=flat)](mailto:kiranwls6@gmail.com)

---

I'm a passionate **DevOps & Site Reliability Engineer (SRE)** with over **10+ years of experience** in building scalable, secure, and highly available cloud platform. Automating infrastructure, enabling CI/CD at scale, and ensuring reliability across AWS and Physical DataCenter.
...
- **Scripting**: Shell  
- **Monitoring**: Splunk, Prometheus, Grafana, CloudWatch, NetOps, Nimbus 
...
- ☁️ Operate services on **AWS Cloud** with **Kubernetes** delivering secure and efficient internal deployments  
- 🚀 Design high-performance **CI/CD pipelines** using **GitHub Actions** and **Jenkins**, reducing delivery friction  
- 📃️ Manage codebases and collaboration with **GitHub** ensuring streamlined source control and peer workflows  
- 🤖 Automate infrastructure and operational tasks using **Linux**, **Shell scripting**, and **Ansible**, improving consistency and speed 
- 🔐 Secure cloud environments using **IAM** and **RBAC**, ensuring compliance and access control  
- 📈 Ensure observability and performance with **Splunk**, **Prometheus**, **CloudWatch** and **NetOps**, minimizing downtime
